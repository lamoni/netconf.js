...
var Netconf = function(options) {
    ...
    */
    ...
    this.defaultOptions = {
        port: 830,
        mode: 'single' /** 'single' means the blocking occurs at the connection level, 'multiple' means the blocking occurs at the command level**/
    };
...
Netconf.prototype.__proto__ = EventEmitter.prototype;
